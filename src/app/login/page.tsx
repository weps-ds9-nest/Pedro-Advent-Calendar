          ...
          <form action={formAction} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="••••••••"
                className="w-full rounded-xl px-4 py-3 text-slate-100 placeholder-slate-600 outline-none transition-all duration-200 focus:ring-2"
                style={{
            ...
            >
              {isPending ? 'Verifying…' : 'Enter the Calendar →'}
            </button>
          </form>
        </div>
